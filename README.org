#                            -*- mode: org; -*-
#
#+TITLE:              OpenFOAM-4.x Third-Party packages
...
*** Parallel Processing
***** Scotch
      Scotch-6.0.3 is provided with ThirdParty-4.x or the original source pack
...
*** ParaView
    ...
    ThirdParty-4.x but older versions can be downloaded from [[www.paraview.org]]:
...
*** Building ParaView-4.3.1/4.4.0/5.0.0/5.0.1
    ...
    commented from file
    /ThirdParty-4.x/ParaView-[45].?.?/Qt/Components/CMakeLists.txt/ after
